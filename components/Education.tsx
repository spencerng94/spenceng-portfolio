                    ...
                    <div className="mt-4 pt-4 border-t border-stone-800">
                      ...
                      <ul className="space-y-1.5">
                        {edu.courses.map((course, cIdx) => (
                          <li key={cIdx} className="text-xs text-stone-400 flex items-start gap-2 leading-snug" style={{ letterSpacing: '-0.01em' }}>
                             <CheckCircle2 size={12} className="text-green-500 mt-0.5 flex-shrink-0" />
                             <span className="leading-snug" style={{ letterSpacing: '-0.01em' }}>{course}</span>
                          </li>
                        ))}
                      </ul>
                    </div>
